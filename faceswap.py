...
if __name__ == '__main__':
    ...
    # 读取图片
    filename1 = 'testimage\\hillary_clinton.jpg'
    filename2 = 'testimage\\gakki1.jpg'
    ...
    try:
        key = "At0ndsJ0Q5qhEDzViAiQDAi8KJGutPjE"
        secret = "cuPyLap40YUkpQHHeXBOuXbpJFXGtoYI"

        # Read array of corresponding points
        points1 = get_points(filename1,key,secret)
        points2 = get_points(filename2,key,secret)
    except KeyError:
        key = "bAUAhvP6sgp27_nZORL0r8y95NNMMaOR"
        secret = "ZH6xcOURIhD5KsNC0nqzRP7OmDAojZis"
