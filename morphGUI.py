...
class Ui_Morph(QMainWindow):
    def __init__(self):
        super(Ui_Morph, self).__init__()
        self.setupUi(self)

    def getAlphaPic(self):
        self.alpha=eval(self.lineEdit.text())
        print(self.alpha)
        getPic(self.fname,self.fname2,self.alpha)
        self.pic=Ui_Pic()
        self.pic.show()

    def getGIF(self):
        gen20Pics(self.fname,self.fname2)
        createGIF()
        self.gif = Ui_MainWindow()
        self.gif.show()
        #gif.exec_()

    def loadFile2(self):
        print("load--file")
        #self.fname2=QFileDialog.getExistingDirectory()
...
"background-color: rgb(255, 255, 255);")
        ...
        self.pushButton.setGeometry(QtCore.QRect(580, 520, 161, 51))
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(120, 520, 161, 51))
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(580, 610, 161, 51))
        ...
        self.pushButton_3.clicked.connect(self.getGIF)
        ...
        self.pushButton_4.clicked.connect(self.getAlphaPic)
        ...
        #input alpha
        self.lineEdit = QtWidgets.QLineEdit(Morph)
        self.lineEdit.setGeometry(QtCore.QRect(120, 610, 161, 51))
        self.lineEdit.setObjectName("lineEdit")
        self.lineEdit.setStyleSheet("color:white")
        self.labelAlpha = QtWidgets.QLabel(Morph)
        self.labelAlpha.setGeometry(QtCore.QRect(120, 580, 150, 30))
        self.labelAlpha.setStyleSheet("font: 75 10pt \"微软雅黑\";color:#ffffff")
        self.labelAlpha.setObjectName("label")
    ...
    def retranslateUi(self, Morph):
        ...
        Morph.setWindowTitle(_translate("Morph", "Morth"))
        ...
        self.label_3.setText(_translate("Morph", "Face Morphing"))
